...
присвоить переменной значение, полученное из
формы name=name
$message .= "E-mail: ""$_POST['email']."<br>";
/ /полученное из формы name=email $message .= "Номер телефона: ""$_POST['number']."
<br>"; // полученное из формы name=phone
$message = "Сообщение: " $_POST [ 'message']."
<br>"; // полученное из формы name=message
